...
const pdfTemplate = require("../../template/pdf/report");
         ...
         if(params.type=="excel"){
          ...
          data.message[0].forEach(function(x) {
            ...
            ws.cell(cont, 6)
              ...
              .style(style);
            ws.cell(cont, 7)
              .string(`${x.Nota_Sistema1 || 0 }`)
              .style(style);
            ws.cell(cont, 8)
              .string(`${x.Nota_Presencial1 || 0}`)
              .style(style);
            ws.cell(cont, 9)
              .string(`${x.Nota_Total_Curso1}`)
              .style(style);
            ws.cell(cont, 10)
              ...
              .style(style);
            ws.cell(cont, 11)
              .string(`${x.Nota_Sistema2 || 0}`)
              .style(style);
            ws.cell(cont, 12)
              .string(`${x.Nota_Presencial2 || 0}`)
              .style(style);
            ws.cell(cont, 13)
              .string(`${x.Nota_Total_Curso2}`)
              .style(style);
            ws.cell(cont, 14)
              ...
              .style(style);
            ws.cell(cont, 15)
              .string(`${x.Nota_Sistema3 || 0}`)
              .style(style);
            ws.cell(cont, 16)
              .string(`${x.Nota_Presencial3 || 0}`)
              .style(style);
            ws.cell(cont, 17)
              .string(`${x.Nota_Total_Curso3}`)
              .style(style);
            ws.cell(cont, 18)
              ...
              .style(style);
            ws.cell(cont, 19)
              .string(`${x.Nota_Sistema4 || 0}`)
              .style(style);
            ws.cell(cont, 20)
              .string(`${x.Nota_Presencial4 || 0}`)
              .style(style);
            ws.cell(cont, 21)
              .string(`${x.Nota_Total_Curso4}`)
              .style(style);
            ws.cell(cont, 22)
              ...
              .style(style);
            ws.cell(cont, 23)
              .string(`${x.Nota_Sistema5 || 0}`)
              .style(style);
            ws.cell(cont, 24)
              .string(`${x.Nota_Presencial5 || 0}`)
              .style(style);
            ws.cell(cont, 25)
              .string(`${x.Nota_Total_Curso5}`)
              .style(style);
            ws.cell(cont, 26)
              ...
              .style(style);
            ws.cell(cont, 27)
              .string(`${x.Nota_Sistema6 || 0}`)
              .style(style);
            ws.cell(cont, 28)
              .string(`${x.Nota_Presencial6 || 0}`)
              .style(style);
            ws.cell(cont, 29)
              .string(`${x.Nota_Total_Curso6}`)
              .style(style);
            ws.cell(cont, 30)
              ...
              .style(style);
            ws.cell(cont, 31)
              .string(`${x.Nota_Sistema7 || 0}`)
              .style(style);
            ws.cell(cont, 32)
              .string(`${x.Nota_Presencial7 || 0}`)
              .style(style);
            ws.cell(cont, 33)
              .string(`${x.Nota_Total_Curso7}`)
              .style(style);
            ws.cell(cont, 34)
              ...
              .style(style);
            ws.cell(cont, 35)
              .string(`${x.Nota_Sistema8 || 0}`)
              .style(style);
            ws.cell(cont, 36)
              .string(`${x.Nota_Presencial8 || 0}`)
              .style(style);
            ws.cell(cont, 37)
              .string(`${x.Nota_Total_Curso8}`)
              .style(style);
            ws.cell(cont, 38)
              ...
              .style(style);
            ws.cell(cont, 39)
              .string(`${x.Nota_Sistema9 || 0}`)
              .style(style);
            ws.cell(cont, 40)
              .string(`${x.Nota_Presencial9 || 0}`)
              .style(style);
            ws.cell(cont, 41)
              .string(`${x.Nota_Total_Curso9 || 0}`)
              .style(style);
            ws.cell(cont, 42)
              .string(`${x.Materia10 || " "}`)
              .style(style);
            ws.cell(cont, 43)
              .string(`${x.Nota_Sistema10 || 0}`)
              .style(style);
            ws.cell(cont, 44)
              .string(`${x.Nota_Presencial10 || 0}`)
              .style(style);
            ws.cell(cont, 45)
              .string(`${x.Nota_Total_Curso10 || 0}`)
              .style(style);
            ws.cell(cont, 46)
              .string(`${x.Cohorte}`)
              .style(style);
          ...
          const name = `calificación_completa_cohorte.pdf`
